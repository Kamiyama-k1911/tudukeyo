...
ActiveRecord::Schema.define(version: 2021_02_12_085809) do
  ...
  create_table "habit_actions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "habit_id", null: false
    t.string "name"
    t.boolean "is_done"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["habit_id"], name: "index_habit_actions_on_habit_id"
  end
  ...
  create_table "tweet_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  add_foreign_key "habit_actions", "habits"
